                ...
                foreach ($rows as $row) {
                    ...
                    if ($funcionario && $tipo_ausentismo) {
                        ...
                        $data = [
                            ...
                            'turno_funcionario'         => $turnante ? 'Si' : 'No',
                            'fecha'                     => "{$fecha_inicio->format('d-m-Y')} / {$fecha_termino->format('d-m-Y')}",
                            'hora_inicio'               => $hora_inicio->format('H:i'),
                            'hora_termino'              => $hora_termino->format('H:i'),
                            'total_horas'               => $diff_hours != null ? "{$diff_hours->h}:{$diff_hours->i}" : '',
                            'descuento'                 => $tiene_descuento ? 'Si' : 'No',
                        ];
