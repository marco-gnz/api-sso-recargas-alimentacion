...
class RecargaCargaDatosResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'last_ajuste'                   => $this->reajustes()->where('tipo_carga', true)->count() > 0 ? Carbon::parse($this->reajustes()->where('tipo_carga', true)->orderBy('created_at', 'DESC')->first()->created_at)->format('d-m-Y H:i:s') : null,
        ];
    }
}
