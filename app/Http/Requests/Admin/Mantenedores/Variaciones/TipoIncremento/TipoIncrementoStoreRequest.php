...
class TipoIncrementoStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            'tipo'          => ['required'],
            'codigo_sirh'   => ['nullable', Rule::unique('tipo_incrementos', 'codigo_sirh')],
            'nombre'        => ['required', Rule::unique('tipo_incrementos', 'nombre')],
            'sigla'         => ['required', Rule::unique('tipo_incrementos', 'sigla')]
        ];
    }
